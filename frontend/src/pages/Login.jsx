...
function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950">
      ...
      >
        <h1 className="text-3xl font-bold text-center text-white mb-8 tracking-tight">Welcome Back</h1>
        ...
        <p className="text-slate-400 text-center mt-6">
          Don't have an account? <Link to="/register" className="text-cyan-400 hover:text-cyan-300 transition-colors font-medium">Register</Link>
        </p>
      </motion.div>
    </div>
  );
